...
//obtenemos cliente por su id
Flight::route('GET /hotels/@id', function($id) {
...
//borramos un cliente  a traves de id, que se indica en la propia ruta
Flight::route('DELETE /clientes/@id', function ($id) {
   ...
   //borramos un hotel  a traves de id, que se indica en la propia ruta
   ...
   Flight::route('DELETE /reservas/@id', function ($id) {
