...
include ->  incluye y evalúa el archivo especificado, en caso de error emitirá una advertencia (E_WARNING) lo cual permite continuar el script

include_once ->   similar al de la sentencia include(), siendo la única diferencia que si el código del fichero ya ha sido incluido, no se volverá a incluir. Como su nombre lo indica, será incluido sólo una vez.

require -> incluye y evalúa el archivo especificado pero en caso de error  producirá un error de nivel E_COMPILE_ERROR fatal y detiene el script.
